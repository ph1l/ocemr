...
for o in Visit.objects.all():
    w.writerow(
        cfr([
            o.pk, o.patient.pk, o.scheduledDate, o.status, o.reason,
            o.reasonDetail, o.followupTo, o.seenDateTime, o.resolvedDateTime
        ]))
...
for o in Diagnosis.objects.all():
    w.writerow(
        cfr([
            o.type.pk, o.type.icpc2Code, o.type.title, o.patient.pk,
            o.visit.pk, o.status, o.notes
        ]))
...
for o in Med.objects.all():
    w.writerow(
        cfr([
            o.pk, o.type.title, o.patient.pk, o.visit.pk, o.diagnosis.pk,
            o.dosage, o.dispenseAmount, o.status
        ]))
