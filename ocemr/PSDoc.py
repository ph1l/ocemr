...
class PSDoc():
    ...
    def __init__(self, font_size=12, margins=None, debug=False):
        ...
        if self.debug:
            ...
            #Top
            self.ps.line((self.dpi * self.margin_left,
                          self.dpi * (self.page_height - self.margin_top)),
    ...
    def text(self, text, font_size=None, indent=0):
        ...
        if self.cur_h == -1:
            self.cur_h = int(
                self.dpi * (self.page_height - self.margin_top)) - (font_size)
