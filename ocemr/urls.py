...
#	document_root = settings.APP_PATH + '/static_media'),
    ...
    url(r'^visit/(?P<id>\d+)/vacs/$', views.visit.visit_vacs),
    ...
    url(r'^visit/(?P<id>\d+)/immu/$', views.visit.visit_immu),
    url(r'^visit/(?P<id>\d+)/immu/new/$', views.visit.visit_immu_new),
    ...
    url(r'^vac/new/(?P<pid>\d+)/(?P<vtid>\d+)/$', views.vac.vac_new),
    url(r'^vac/del/(?P<pid>\d+)/(?P<vtid>\d+)/$', views.vac.vac_del),
    url(r'^vac/notate/(?P<pid>\d+)/(?P<vtid>\d+)/$', views.vac.vac_notate),
    url(r'^vac/edit_received/(?P<vid>\d+)/$', views.vac.vac_edit_received),
