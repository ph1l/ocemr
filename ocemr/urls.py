...
urlpatterns = [
    ...
    url(r'^autospel_name/(?P<inapp>.+)/(?P<inmodel>.+)/$',
        views.util.autospel_name),
    url(r'^autocomplete_name/(?P<inapp>.+)/(?P<inmodel>.+)/$',
        views.util.autocomplete_name),
    url(r'^autosearch_title/(?P<inapp>.+)/(?P<inmodel>.+)/$',
    ...
    url(r'^patient_queue/(?P<dayoffset>[-0-9]+)/$',
        views.patient.patient_queue),
    url(r'^select_date_for_patient_queue/$',
        views.patient.select_date_for_patient_queue),
    url(r'^patient/(?P<id>\d+)/$', views.patient.patient),
    url(r'^patient/edit/age/(?P<id>\d+)/$', views.patient.patient_edit_age),
    url(r'^patient/edit/village/(?P<id>\d+)/$',
        views.patient.patient_edit_village),
    ...
    url(r'^patient/edit/gender/(?P<id>\d+)/$',
        views.patient.patient_edit_gender),
    url(r'^patient/edit/phone/(?P<id>\d+)/$',
        views.patient.patient_edit_phone),
    url(r'^patient/edit/email/(?P<id>\d+)/$',
        views.patient.patient_edit_email),
    url(r'^patient/edit/alt_contact_name/(?P<id>\d+)/$',
        views.patient.patient_edit_alt_contact_name),
    url(r'^patient/edit/alt_contact_phone/(?P<id>\d+)/$',
    ...
    url(r'^patient/schedule_new_visit/(?P<id>\d+)/$',
        views.patient.schedule_new_visit),
    url(r'^patient/schedule_walkin_visit/(?P<id>\d+)/$',
    ...
    url(r'^patient/edit_visit_reason/(?P<id>\d+)/$',
        views.patient.edit_visit_reason),
    url(r'^patient/edit_visit_seen/(?P<id>\d+)/$',
        views.patient.edit_visit_seen),
    url(r'^patient/merge/(?P<id>\d+)/$', views.patient.patient_merge),
    url(r'^patient/merge/(?P<id>\d+)/(?P<dupid>\d+)/$',
        views.patient.patient_do_merge),
    ...
    url(r'^visit/(?P<id>\d+)/allergy/delete/(?P<oid>\d+)/$',
    ...
    url(r'^visit/(?P<id>\d+)/subj/new/(?P<symptomtypeid>\d+)/$',
        views.visit.visit_subj_new),
    url(r'^visit/(?P<id>\d+)/subj/edit/(?P<visitsymptomid>\d+)/$',
        views.visit.visit_subj_edit),
    url(r'^visit/(?P<id>\d+)/subj/delete/(?P<visitsymptomid>\d+)/$',
        views.visit.visit_subj_delete),
    url(r'^visit/(?P<id>\d+)/obje/$', views.visit.visit_obje),
    url(r'^visit/(?P<id>\d+)/obje/vitals/new/$',
        views.visit.visit_obje_vitals_new),
    #url(r'^visit/(?P<id>\d+)/obje/vital/new/(?P<vitaltypeid>\d+)/$', views.visit.visit_obje_vital_new),
    url(r'^visit/(?P<id>\d+)/obje/vital/delete/(?P<oid>\d+)/$',
        views.visit.visit_obje_vital_delete),
    url(r'^visit/(?P<id>\d+)/obje/examNote/new/(?P<examnotetypeid>\d+)/$',
        views.visit.visit_obje_examNote_new),
    url(r'^visit/(?P<id>\d+)/obje/examNote/edit/(?P<examnoteid>\d+)/$',
    ...
    url(r'^visit/(?P<id>\d+)/labs/new/(?P<labtypeid>\d+)/$',
        views.visit.visit_labs_new),
    url(r'^visit/(?P<id>\d+)/plan/$', views.visit.visit_plan),
    url(r'^visit/(?P<id>\d+)/plan/diag/new/$',
        views.visit.visit_plan_diag_new),
    url(r'^visit/(?P<id>\d+)/plan/diag/new/(?P<dtid>\d+)/$',
        views.visit.visit_plan_diag_new_bytype),
    url(r'^visit/(?P<id>\d+)/meds/$', views.visit.visit_meds),
    url(r'^visit/(?P<id>\d+)/meds/new/(?P<did>\d+)/$',
        views.visit.visit_meds_new),
    url(r'^visit/(?P<id>\d+)/refe/$', views.visit.visit_refe),
    url(r'^visit/(?P<id>\d+)/refe/new/$', views.visit.visit_refe_new),
    url(r'^visit/(?P<id>\d+)/refe/edit/(?P<refid>\d+)/$',
        views.visit.visit_refe_edit),
    ...
    url(r'^visit/(?P<id>\d+)/cost_estimate_detail/$',
    ...
    url(r'^diag/(?P<id>\d+)/stat_change/(?P<newstat>\w+)/$',
        views.diag.diag_stat_change),
    url(r'^diag/(?P<id>\d+)/edit/notes/$', views.diag.diag_edit_notes),
    url(r'^diag/(?P<id>\d+)/history/$', views.diag.diag_history),
    url(r'^diag/patienttypehistory/(?P<pid>\d+)/(?P<dtid>\d+)/$',
    ...
    url(r'^reports/legacy/patient/daily/$',
        views.reports.legacy_patient_daily),
    ...
    url(r'^reports/accounts_outstanding/$',
        views.reports.accounts_outstanding),
    ...
    url(r'^graphs/vitals/(?P<id>\d+)/hw.png$',
        views.graphs.vitals_height_weight),
    url(r'^graphs/vitals/(?P<id>\d+)/spo2o2.png$',
        views.graphs.vitals_spo2_o2),
